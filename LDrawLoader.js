...
const SRGBColorSpace = THREE.SRGBColorSpace; // Note: Verify this as constants may not always be directly under THREE
...
class LDrawLoader extends THREE.Loader {
	...
	constructor( manager ) {
		...
		this.missingColorMaterial = new THREE.MeshStandardMaterial( { name: Loader.DEFAULT_MATERIAL_NAME, color: 0xFF00FF, roughness: 0.3, metalness: 0 } );
		this.missingEdgeColorMaterial = new THREE.LineBasicMaterial( { name: Loader.DEFAULT_MATERIAL_NAME, color: 0xFF00FF } );
	...
	parseColorMetaDirective( lineParser ) {
		...
		switch ( finishType ) {
			...
			case FINISH_TYPE_DEFAULT:
				...
				material = new THREE.MeshStandardMaterial( { roughness: 0.3, metalness: 0 } );
				break;

			case FINISH_TYPE_PEARLESCENT:

				// Try to imitate pearlescency by making the surface glossy
				material = new THREE.MeshStandardMaterial( { roughness: 0.3, metalness: 0.25 } );
				break;

			case FINISH_TYPE_CHROME:

				// Mirror finish surface
				material = new THREE.MeshStandardMaterial( { roughness: 0, metalness: 1 } );
				break;
			...
			case FINISH_TYPE_MATTE_METALLIC:
				...
				material = new THREE.MeshStandardMaterial( { roughness: 0.8, metalness: 0.4 } );
				break;

			case FINISH_TYPE_METAL:

				// Average metal finish
				material = new THREE.MeshStandardMaterial( { roughness: 0.2, metalness: 0.85 } );
				break;
		...
		if ( ! edgeMaterial ) {
			...
			edgeMaterial = new THREE.LineBasicMaterial( {
				color: new THREE.Color().setStyle( edgeColor, COLOR_SPACE_LDRAW ),
